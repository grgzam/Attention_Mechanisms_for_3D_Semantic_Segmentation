...
class SPVCNN(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.pt1 = PointTransformer(cs[4],cs[4])
        self.pt2 = PointTransformer(cs[6],cs[6])
        self.pt3 = PointTransformer(cs[8],cs[8])
