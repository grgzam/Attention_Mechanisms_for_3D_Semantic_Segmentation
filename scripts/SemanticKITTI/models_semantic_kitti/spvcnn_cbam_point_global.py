import os # gia to visualize
import numpy as np #gia to visualize
import torchsparse
...
class SPVCNN(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.cbam1 = CBAM(cs[4])
        self.cbam2 = CBAM(cs[6])
        self.cbam3 = CBAM(cs[8])
    ...
    def forward(self, x):
        ...
        pt1 = PointTensor(self.point_transforms[0](z0.F),z0.C)
        z1.F = z1.F + self.cbam1(pt1)
        ...
        pt2 = PointTensor(self.point_transforms[1](z1.F),z1.C)
        z2.F = z2.F + self.cbam2(pt2)
        ...
        pt3 = PointTensor(self.point_transforms[2](z2.F),z2.C)
        z3.F = z3.F + self.cbam3(pt3)
