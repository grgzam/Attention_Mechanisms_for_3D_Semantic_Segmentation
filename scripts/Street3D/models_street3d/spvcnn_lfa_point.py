...
class SPVCNN(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.lfa1 = LFA(cs[4],cs[4])
        self.lfa2 = LFA(cs[6],cs[6])
        self.lfa3 = LFA(cs[8],cs[8])
    ...
    def forward(self, x):
        ...
        z2.F = z2.F + self.lfa2(pt2,idx,dist)
        ...
        z3.F = z3.F + self.lfa3(pt3,idx,dist)
